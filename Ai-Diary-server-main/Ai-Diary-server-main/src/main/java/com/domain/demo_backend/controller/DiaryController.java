...
public class DiaryController {
    ...
    private  DiaryService diaryService;
      ...
      @ResponseBody
      public ResponseEntity<String> addDiaryList(@ModelAttribute DiaryRequest diaryReq, @RequestHeader("X-Forwarded-For") String ip) {
          ...
          return ResponseEntity.ok("일기를 작성했습니다.");
      }
